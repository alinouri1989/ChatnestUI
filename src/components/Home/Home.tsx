  ...
  return (
    <div className='home-general-box'>
      ...
      <motion.div
        ...
        animate="animate"
      >
        <h2>ChatNest را برای اندروید دانلود کنید</h2>
        <p>
          با ChatNest فوری متصل شوید؛ گفت‌وگو کنید و به گروه‌ها بپیوندید
          و فاصله‌ها را با تماس صوتی از بین ببرید!
        </p>
        <a href="/files/ChatNest_v1.0.apk" download="ChatNest_v1.0.apk">
          <button>دانلود نسخه نهایی</button>
        </a>
     </motion.div>
      ...
      >
        ...
        <p>گفت‌وگوهای شخصی شما سرتاسر رمزگذاری شده‌اند</p>
      </motion.div>
    </div>
  );
}
