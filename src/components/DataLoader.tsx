...
import { getRefreshToken } from "../store/helpers/tokenStorage";
...
import { registerBrowserFirebaseToken } from "../services/firebaseNotifications";
...
const DataLoader = ({ children }) => {
  ...
  useEffect(() => {
    ...
    registerBrowserFirebaseToken({ forceSync: true }).catch((error) => {
