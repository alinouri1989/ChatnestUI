// @ts-nocheck
import { hasLegacyOnlineMarker, isUserOnline } from "./presenceHelper";

const LABEL_ONLINE = "\u0622\u0646\u0644\u0627\u06cc\u0646";
const LABEL_OFFLINE = "\u0622\u0641\u0644\u0627\u06cc\u0646";
...
export const formatDateForLastConnectionDate = (dateString, explicitOnline) => {
  if (isUserOnline(dateString, explicitOnline)) {
    return LABEL_ONLINE;
  }

  if (!dateString || (explicitOnline === false && hasLegacyOnlineMarker(dateString))) {
