...
import { useSignInWithEmailMutation } from '../../../store/Slices/auth/authApi';

import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import { signInSchema } from '../../../schemas/SignSchemas';
...
function SignIn() {
  ...
  const handleSignInWithEmail = async (data) => {
    try {
      ...
      ErrorAlert(error?.data?.errorDetails || "خطایی رخ داده است");
    }
  };
  ...
  return (
    <motion.div
      ...
      {...opacityEffect()}>
      <img src={logoSrc} alt="ChatNest لوگو" />
