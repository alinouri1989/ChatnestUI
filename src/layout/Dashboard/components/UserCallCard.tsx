...
function UserCallCard({ callId, image, status, isOnline, name, callType, callStatus, createdDate, isOutgoingCall }) {
  ...
  const userStatus = isUserOnline(status, isOnline) ? 'online' : 'offline';
